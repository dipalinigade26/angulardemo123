				...
				<div class="comp_list">
					...
					foreach($competition as $row){
						...
						<div class="col-lg-6 <?php if($i % 2 == 0){ echo 'left';}else{echo 'right';}?>7">
							<div class="box_comp">
								<div class="hero">
									<img class="hero__background" src="<?php echo file_upload_base_url();?>competition/banner/<?php echo $row['banner'];?>">
									<div class="hero__title">
										<a href="<?php echo base_url();?>competition/<?php echo $row['pageName'];?>">
											<img src="<?php echo file_upload_base_url();?>competition/profile_image/thumbs/<?php echo $row['profile_image'];?>" alt="" class="img-circle">
										</a>
										<?php
										$atr = $row['name'];
										if(strlen($atr) > 38){
								...
								<div class="hero2">
									<a href="<?php echo base_url();?>competition/<?php echo $row['pageName'];?>">
										<img class="hero2__background" src="<?php echo file_upload_base_url();?>competition/banner/<?php echo $row['banner'];?>">
									</a>
								</div>
							</div>
						</div>
